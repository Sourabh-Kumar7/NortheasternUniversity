...
## [your code here]
# This selects the third and forth row and first and second column, forming a 2 by 2 square
mm[c(3,4),c(1,2)]
## you can also invert
mm[-c(1,2),-c(3,4)]
## this is a generic version which works for all matrices, not only a 4x4 one.
mm[c(dim(mm)[1]-1, dim(mm)[1]), c(1, 2)]


## Q: anything specific you'd like to know about R?
## I would like to learn more about linear regression
